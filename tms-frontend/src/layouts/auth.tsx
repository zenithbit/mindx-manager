...
import mindx from "@/assets/imgs/ptit.png";
        ...
        <>
          <div className={styles.bar_icon}>
            <Image
              src={dotArea}
              alt=""
              className={`${styles.absolute} ${styles.top_0} ${styles.zIndex}`}
            />
            <Image src={mindx} alt="" className={styles.icon} />
            <Image
              src={waveLineArea}
              alt=""
              className={`${styles.absolute} ${styles.bt_0} ${styles.zIndex}`}
            />
          </div>
          <div className={styles.content_auth}>{props.children}</div>
        </>
      )}
    </div>
  );
