...
const IconDocument = (props: HTMLAttributes<HTMLElement | any>) => {
    return (
        <svg {...props} width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M4 6V19C4 20.6569 5.34315 22 7 22H17C18.6569 22 20 20.6569 20 19V9C20 7.34315 18.6569 6 17 6H4ZM4 6V5" stroke="#1C274D" strokeWidth="1.5" />
            ...
            <path opacity="0.5" d="M8 12H16" stroke="#1C274D" strokeWidth="1.5" strokeLinecap="round" />
            <path opacity="0.5" d="M8 15.5H13.5" stroke="#1C274D" strokeWidth="1.5" strokeLinecap="round" />
        </svg>
    )
}
